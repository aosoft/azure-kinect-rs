...
impl Device<'_> {
    ...
    pub fn get_color_control(
        ...
        let mut value: i32 = 0;
        Error::from_k4a_result_t((self.api.funcs.k4a_device_get_color_control)(
            self.handle,
            command,
            &mut mode,
            &mut value,
    ...
    pub fn set_color_control(
        ...
        Error::from_k4a_result_t((self.api.funcs.k4a_device_set_color_control)(
            self.handle,
            command,
            mode,
            value,
    ...
    pub fn get_color_control_capabilities(
        ...
        Error::from_k4a_result_t((self.api.funcs.k4a_device_get_color_control_capabilities)(
            self.handle,
            command,
    ...
    pub fn get_calibration(
        ...
        Error::from_k4a_result_t((self.api.funcs.k4a_device_get_calibration)(
            self.handle,
            depth_mode,
            color_resolution,
            &mut calibaraion,
    ...
    pub fn is_sync_connected(&self) -> Result<(bool, bool), Error> {
        ...
        Error::from_k4a_result_t((self.api.funcs.k4a_device_get_sync_jack)(
            self.handle,
    ...
    pub fn get_version(&self) -> Result<k4a_hardware_version_t, Error> {
        ...
        Error::from_k4a_result_t((self.api.funcs.k4a_device_get_version)(
            self.handle,
            &mut version,
        ))
        .to_result(version)
