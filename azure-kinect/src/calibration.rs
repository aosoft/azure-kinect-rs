...
impl Calibration<'_> {
    ...
    pub fn from_raw<'a>(
        ...
        Error::from_k4a_result_t((factory.api.funcs.k4a_calibration_get_from_raw)(
    ...
    pub fn convert_3d_to_3d(
        ...
        Error::from_k4a_result_t((self.api.funcs.k4a_calibration_3d_to_3d)(
            &self.calibration,
            source_point3d,
            source_camera,
            target_camera,
    ...
    pub fn convert_2d_to_3d(
        ...
        let mut target_point3d = k4a_float3_t::default();
        let mut valid: i32 = 0;
        Error::from_k4a_result_t((self.api.funcs.k4a_calibration_2d_to_3d)(
            &self.calibration,
            source_point2d,
            source_depth,
            source_camera,
    ...
    pub fn convert_3d_to_2d(
        ...
        let mut valid: i32 = 0;
        Error::from_k4a_result_t((self.api.funcs.k4a_calibration_3d_to_2d)(
            &self.calibration,
            source_point3d,
            source_camera,
            target_camera,
    ...
    pub fn convert_2d_to_2d(
        ...
        let mut target_point2d = k4a_float2_t::default();
        let mut valid: i32 = 0;
        Error::from_k4a_result_t((self.api.funcs.k4a_calibration_2d_to_2d)(
            &self.calibration,
            source_point2d,
            source_depth,
            source_camera,
    ...
    pub fn convert_color_2d_to_depth_2d(
        ...
        let mut target_point2d = k4a_float2_t::default();
        let mut valid: i32 = 0;
        Error::from_k4a_result_t((self.api.funcs.k4a_calibration_color_2d_to_depth_2d)(
            &self.calibration,
            source_point2d,
            depth_image.handle,
            &mut target_point2d,
