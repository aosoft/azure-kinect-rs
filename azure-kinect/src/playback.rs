...
impl Playback<'_> {
    ...
    pub fn get_next_capture(&self) -> Result<Capture, Error> {
        ...
        Error::from((self.factory.k4a_playback_get_next_capture)(
            self.handle,
            &mut handle,
        ))
    ...
    pub fn get_previous_capture(&self) -> Result<Capture, Error> {
        let mut handle: k4a_capture_t = ptr::null_mut();
        Error::from((self.factory.k4a_playback_get_previous_capture)(
            self.handle,
            &mut handle,
        ))
        .to_result_fn(&|| Capture::from_handle(&self.factory.k4a, handle))
    ...
    pub fn get_tag(&self, name: &str) -> Result<String, Error> {
        ...
        get_k4a_string(&|tag, buffer| {
            (self.factory.k4a_playback_get_tag)(
                self.handle,
                name.as_ptr(),
                tag,
                buffer as *mut size_t,
    ...
    pub fn get_next_imu_sample(&self) -> Result<k4a_imu_sample_t, Error> {
        ...
        Error::from((self.factory.k4a_playback_get_next_imu_sample)(
            self.handle,
            &mut imu_sample,
        ))
    ...
    pub fn get_previous_imu_sample(&self) -> Result<k4a_imu_sample_t, Error> {
        let mut imu_sample = k4a_imu_sample_t::default();
        Error::from((self.factory.k4a_playback_get_previous_imu_sample)(
            self.handle,
            &mut imu_sample,
        ))
        .to_result(imu_sample)
    ...
    pub fn seek_timestamp(
        ...
        Error::from((self.factory.k4a_playback_seek_timestamp)(
            self.handle,
            offset_usec,
            origin,
        ))
    ...
    pub fn get_recording_length_usec(&self) -> u64 {
        (self.factory.k4a_playback_get_recording_length_usec)(self.handle)
    }
    ...
    pub fn set_color_conversion(&self, format: k4a_image_format_t) -> Result<(), Error> {
        Error::from((self.factory.k4a_playback_set_color_conversion)(
            self.handle,
            format,
        ))
        .to_result(())
    ...
    pub fn get_next_data_block(&self, track: &str) -> Result<PlaybackDataBlock, Error> {
        ...
        Error::from((self.factory.k4a_playback_get_next_data_block)(
            self.handle,
            track.as_ptr(),
            &mut block_handle,
        ))
    ...
    pub fn get_previous_data_block(&self, track: &str) -> Result<PlaybackDataBlock, Error> {
        ...
        Error::from((self.factory.k4a_playback_get_previous_data_block)(
            self.handle,
            track.as_ptr(),
            &mut block_handle,
        ))
    ...
    pub fn get_attachment(&self, attachment: &str) -> Result<Vec<u8>, Error> {
        ...
        get_k4a_binary_data(&|data, data_size| {
            (self.factory.k4a_playback_get_attachment)(
                self.handle,
                attachment.as_ptr(),
                data,
