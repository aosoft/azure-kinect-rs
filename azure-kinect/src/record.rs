...
impl Record<'_> {
    ...
    pub fn flush(&self) -> Result<(), Error> {
        Error::from_k4a_result_t(unsafe { (self.api_record.funcs.k4a_record_flush)(self.handle) } ).to_result(())
    }
    ...
    pub fn add_tag(&self, name: &str, value: &str) -> Result<(), Error> {
        ...
        Error::from_k4a_result_t(unsafe {(self.api_record.funcs.k4a_record_add_tag)(
            self.handle,
            name.as_ptr(),
            value.as_ptr(),
        ) } )
    ...
    pub fn add_imu_track(&self) -> Result<(), Error> {
        Error::from_k4a_result_t(unsafe { (self.api_record.funcs.k4a_record_add_imu_track)(self.handle) } ).to_result(())
    }
    ...
    pub fn add_attachment(&self, attachment_name: &str, buffer: &[u8]) -> Result<(), Error> {
        ...
        Error::from_k4a_result_t(unsafe { (self.api_record.funcs.k4a_record_add_attachment)(
            self.handle,
    ...
    pub fn add_custom_video_track(
        ...
        Error::from_k4a_result_t(unsafe { (self.api_record.funcs.k4a_record_add_custom_video_track)(
            self.handle,
            track_name.as_ptr(),
            codec_id.as_ptr(),
    ...
    pub fn add_custom_subtitle_track(
        ...
        let track_name = CString::new(track_name).unwrap_or_default();
        let codec_id = CString::new(codec_id).unwrap_or_default();
        Error::from_k4a_result_t(unsafe { (self.api_record.funcs.k4a_record_add_custom_subtitle_track)(
            self.handle,
            track_name.as_ptr(),
            codec_id.as_ptr(),
            codec_context.as_ptr(),
    ...
    pub fn write_header(&self) -> Result<(), Error> {
        Error::from_k4a_result_t(unsafe { (self.api_record.funcs.k4a_record_write_header)(self.handle) } ).to_result(())
    }

    /// Writes a camera capture to file
    pub fn write_capture(&self, capture: &Capture) -> Result<(), Error> {
        Error::from_k4a_result_t(unsafe { (self.api_record.funcs.k4a_record_write_capture)(
            self.handle,
            capture.handle as _,
        ) } )
        .to_result(())
    ...
    pub fn write_imu_sample(&self, imu_sample: k4a_imu_sample_t) -> Result<(), Error> {
        Error::from_k4a_result_t(unsafe { (self.api_record.funcs.k4a_record_write_imu_sample)(
            self.handle,
    ...
    pub fn write_custom_track_data(
        ...
        let track_name = CString::new(track_name).unwrap_or_default();
        Error::from_k4a_result_t(unsafe { (self.api_record.funcs.k4a_record_write_custom_track_data)(
            self.handle,
            track_name.as_ptr(),
...
impl Drop for Record<'_> {
    fn drop(&mut self) {
        unsafe { (self.api_record.funcs.k4a_record_close)(self.handle); }
