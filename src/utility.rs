...
pub(crate) fn get_k4a_string(f: &Fn(*mut ::std::os::raw::c_char, *mut usize) -> k4a_buffer_result_t) -> Result<String, Error> {
    unsafe {
...
mod tests {
    ...
    fn test() {
        ...
        let f:&Fn(*mut ::std::os::raw::c_char, *mut usize) -> k4a_buffer_result_t = &|s, len|{
            unsafe {
                *len = t1.len() + 1;
