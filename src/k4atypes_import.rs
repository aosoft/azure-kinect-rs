...
type k4a_logging_message_cb_t = fn(context: *mut (), level: k4a_log_level_t, file: &str, line: i32, message: &str);
type k4a_memory_destroy_cb_t = fn(buffer: *mut (), context: *mut ());
type k4a_memory_allocate_cb_t = fn(size: i32, context: *mut *mut ());
...
#[allow(non_camel_case_types)]
#[repr(C)]
struct k4a_calibration_intrinsic_parameters_param  {
    cx: f32,
    cy: f32,
    fx: f32,
    fy: f32,
...
struct k4a_calibration_t {
    ...
    extrinsics: [[k4a_calibration_extrinsics_t; k4a_calibration_t::K4A_CALIBRATION_TYPE_NUM]; k4a_calibration_t::K4A_CALIBRATION_TYPE_NUM],
    depth_mode: k4a_depth_mode_t,
    color_resolution: k4a_color_resolution_t
}
...
const K4A_DEVICE_DEFAULT: i32 = 0;
const K4A_WAIT_INFINITE: i32 = -1;

const K4A_DEVICE_CONFIG_INIT_DISABLE_ALL: k4a_device_configuration_t  = k4a_device_configuration_t {
